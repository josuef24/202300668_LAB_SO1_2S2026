...
func main() {
	...
	mux.HandleFunc("/health", func(w http.ResponseWriter, r *http.Request) {
		...
		json.NewEncoder(w).Encode(HealthResponse{
			Status: "UP", Message: "API1 is Ready", Timestamp: time.Now().Format(time.RFC3339), VM: "VM1", Carnet: "202300668",
		})
	})

	mux.HandleFunc("/api1/202300668/call-api2", func(w http.ResponseWriter, r *http.Request) {
		w.Header().Set("Content-Type", "application/json")
		json.NewEncoder(w).Encode(checkAPI("http://192.168.122.115:8082/health", "API2", "VM1"))
	})

	mux.HandleFunc("/api1/202300668/call-api3", func(w http.ResponseWriter, r *http.Request) {
		w.Header().Set("Content-Type", "application/json")
